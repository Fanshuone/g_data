import time
import warnings
from stock_remove import match_htsc_code, remove_long_day_noupdate
from threads_conduct import Separate, Multi_Thread_Tomysql
from login import login
import pandas as pd
from g_kline import G_Long_kline
...
def long_day_to_insert():
    ...
    mu1.start()
    mu2.start()
    g_data = G_Long_kline(htsc_code, "2018-1-1 0:0:0", "2023-9-13 23:0:0", frequency='daily', queue1=queue1)
    g_data.start_g()
    se.join()
    mu1.join()
    mu2.join()
